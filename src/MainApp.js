...
export class MainApp extends Component {
    ...
    render() {
        ...
        // <>
        //     <div className={"main-background strip"}>
        //         <div className={"mbg1"}/>
        //         <div className={"mbg2"}/>
        //         <h2>ALL SERVICES</h2>
        //     </div>
                ...
                <section className={"section full-page"}>
                    ...
                    <div className={"row"}>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2679.5362862632987!2d-122.37991558417392!3d47.80982408190993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54901afa43eb4b77%3A0x40978f944a4d16a7!2s130%205th%20Ave%20S%2C%20Edmonds%2C%20WA%2098020!5e0!3m2!1sen!2sus!4v1649446313086!5m2!1sen!2sus"
                                width="400" height="300" allowFullScreen="" loading="lazy" id={"map"}
                        ...
                        <p>130 5th Ave S<br/>
                            ...
                            <a href={"https://www.google.com/maps/dir/?api=1&destination=130%205th%20Ave%20S%20Edmonds%20WA%2098020"}
                               target={"_blank"}>Get Directions</a><br/><br/>
                    ...
                    <div className={"row"}>
                        ...
                        <View style={{flexDirection: "column", gap: "1rem", justifyContent: "center"}}>
